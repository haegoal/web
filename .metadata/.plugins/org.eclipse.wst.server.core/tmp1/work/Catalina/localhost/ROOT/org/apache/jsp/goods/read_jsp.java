 ...
 * Generated at: 2023-08-14 02:30:42 UTC
...
public final class read_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("		<h1 class=\"text-center mb-5\">상품정보</h1>\r\n");
      out.write("		<div class=\"row\">\r\n");
      out.write("			<div class=\"col-md-5 m-2 text-center\">\r\n");
      out.write("				<img src=\"");
      ...
      out.write("\" width=\"90%\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"col card m-2 p-5\">\r\n");
      out.write("				<h5>상품코드: ");
      ...
      out.write("</div>\r\n");
      out.write("				<div class=\"my-2\">상품등록일: ");
      ...
      out.write("				<div class=\"row\">\r\n");
      out.write("					<div class=\"col\">\r\n");
      out.write("						<button class=\"btn btn-primary\" id=\"btn-cart\" gid=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${vo.gid}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\">장바구니</button>\r\n");
      out.write("					</div>\r\n");
      out.write("					<div class=\"col text-end\" id=\"count\">\r\n");
      out.write("						<i id=\"heart\" class=\"bi bi-suit-heart\"></i>\r\n");
      out.write("						<span id=\"fcnt\"></span>\r\n");
      out.write("						<i class=\"bi bi-chat-dots\" id=\"asd\"></i>\r\n");
      ...
      out.write("<script>\r\n");
      out.write("	//좋아요 추가\r\n");
      out.write("	$(\"#count\").on(\"click\", \".bi-suit-heart\", function(){\r\n");
      out.write("		if(uid==\"\"){\r\n");
      out.write("			location.href=\"/user/login?target=/goods/read?gid=\"+gid;\r\n");
      out.write("		}else{\r\n");
      out.write("			if(confirm(\"좋아요! 추가하실래요?\")){\r\n");
      out.write("				//좋아요 추가\r\n");
      out.write("				$.ajax({\r\n");
      out.write("					type:\"get\",\r\n");
      out.write("					url:\"/favorite/insert\",\r\n");
      out.write("					data:{gid, uid},\r\n");
      out.write("					success:function(){\r\n");
      out.write("						getFavorite();\r\n");
      out.write("					}\r\n");
      out.write("				});\r\n");
      out.write("			}\r\n");
      out.write("		}	\r\n");
      ...
      out.write("	\r\n");
      out.write("	//좋아요 삭제\r\n");
      out.write("	$(\"#count\").on(\"click\", \".bi-suit-heart-fill\", function(){\r\n");
      out.write("		if(confirm(\"좋아요! 삭제하실래요?\")){\r\n");
      out.write("			//좋아요 삭제\r\n");
      out.write("			$.ajax({\r\n");
      out.write("				type:\"get\",\r\n");
      ...
      out.write("	//좋아요 체크\r\n");
      out.write("	getFavorite();\r\n");
      out.write("	function getFavorite(){\r\n");
      out.write("		$.ajax({\r\n");
      out.write("			type:\"get\",\r\n");
      out.write("			url:\"/favorite/read\",\r\n");
      out.write("			data:{uid, gid},\r\n");
      out.write("			dataType:\"json\",\r\n");
      out.write("			success:function(data){\r\n");
      out.write("				if(data.ucnt==1){\r\n");
      out.write("					$(\"#heart\").removeClass(\"bi-suit-heart\").addClass(\"bi-suit-heart-fill\");\r\n");
      out.write("				}else{\r\n");
      out.write("					$(\"#heart\").removeClass(\"bi-suit-heart-fill\").addClass(\"bi-suit-heart\");\r\n");
      out.write("				}\r\n");
      out.write("				$(\"#fcnt\").html(data.fcnt);\r\n");
      out.write("			}\r\n");
      out.write("		});\r\n");
      out.write("	}\r\n");
      out.write("	\r\n");
      out.write("	$(\"#btn-cart\").on(\"click\", function(){\r\n");
      ...
      out.write("			success:function(){\r\n");
      out.write("				if(confirm(\"계속 쇼핑하실래요?\")) {\r\n");
  ...
  private boolean _jspx_meth_fmt_005fformatNumber_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /goods/read.jsp(27,28) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /goods/read.jsp(27,28) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
